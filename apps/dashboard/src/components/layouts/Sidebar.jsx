            ...
            <div>
              ...
              {contentMenuOpen && (
                <div className="mt-1 space-y-1 transition-all duration-200">
                  ...
                  {/* Navigation */}
                  <NavLink to={`/content/${activeWebsiteId}/navigation`} onClick={() => setMobileOpen(false)} className={subNavItemClass}>
                    <Compass className="w-3.5 h-3.5 flex-shrink-0" />
                    <span>Navigation</span>
                  </NavLink>

                  {/* Layouts */}
                  <NavLink to={`/content/${activeWebsiteId}/layouts`} onClick={() => setMobileOpen(false)} className={subNavItemClass}>
