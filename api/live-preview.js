...
(function () {
  ...
  function applyLiveRegionValue(element) {
    ...
    var responsiveLetterSpacing = window.innerWidth < 768
      ...
      : window.innerWidth < 1024
        ? value.letterSpacingTablet || value.letterSpacing
        : value.letterSpacing;
    var hasLetterSpacing = typeof responsiveLetterSpacing === "string" && responsiveLetterSpacing.length > 0;
...
html[data-rcms-connected-canvas="edit"] [data-rcms-runtime-additions-host] [data-rcms-type="heading"] [data-rcms-add-section],
html[data-rcms-connected-canvas="edit"] [data-rcms-runtime-additions-host] [data-rcms-type="paragraph"] [data-rcms-add-section] {
  display: none !important;
}
